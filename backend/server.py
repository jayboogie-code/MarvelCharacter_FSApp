...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:09122020@localhost/marvel'
...
def create_database():
    root_engine = create_engine("mysql+mysqlconnector://root:09122020@localhost/marvel")  # No database specified
